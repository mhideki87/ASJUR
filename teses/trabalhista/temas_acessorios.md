...
status: validada
gatilhos: [quebra de caixa, substituição, reajuste de ACT, acordo coletivo, dissídio, CIP, POSTALIS, previdência privada, honorários advocatícios, art. 791-A, normativos internos, PLR, reflexos]
pecas: [contestação, contrarrazões, recurso de revista]
modelos: [modelos/trabalhista/contestacao__incorporacao_funcao.md]
ver_tambem: [teses/trabalhista/incorporacao_gratificacao_funcao.md, teses/trabalhista/remuneracao_singular.md]
...
- **Aplicação integral dos normativos internos** — *ad cautelam*: se a norma interna for aplicada, que
  ...
  compensação).
- **Reajustes de ACT** — não existe **reajuste autônomo** de parcela de função incorporada por decisão
  judicial: a parcela não vira salário com índice próprio.
  **Refinamento (2026-08-31):** era enunciado aqui que "as cláusulas de reajuste do ACT incidem sobre a
  tabela salarial, não sobre a tabela de função" — a redação é imprecisa. A **Tabela de Funções das
  Superintendências Estaduais** traz, em seu próprio cabeçalho, o percentual de "reajuste conforme
  dissídio", com vigência em **01/08**: a tabela de função **também** é reajustada, em ato próprio e em data
  própria, distinta da tabela salarial. O que não se sustenta é o pedido de aplicar à parcela incorporada o
  índice da tabela **salarial**, ou de reajustá-la de forma autônoma.
  Consequência prática no regime singular: quando as duas tabelas sobem no **mesmo** percentual, o
  complemento acompanha proporcionalmente; ele **só cai** quando o salário sobe por causa diversa do
  percentual geral — promoção horizontal, progressão, ou reajuste de data-base concedido em **valor fixo**
  (cláusulas de ACT que dão R$ X,00 em vez de percentual). Ver
...
- **Reflexos** — anuênio, férias + gratificação, 13º; impugnar reflexo em **PLR** sempre
  ...
  Conferir também o que **não** foi pedido: reflexo em anuênio e diferenças de CIP não podem ser deferidos se
  a inicial não os deduziu (arts. 141 e 492 do CPC), ainda que a folha mostre que também caíram. E reflexo em
  **horas extras** é impossível quando não há pedido de sobrejornada nem rubrica de horas extras nas fichas
...
- Metodologia e limite do valor a incorporar no regime singular:
  [teses/trabalhista/remuneracao_singular.md](remuneracao_singular.md)
