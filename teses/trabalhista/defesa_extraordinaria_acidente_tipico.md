...
A ECT obteve acórdão regional favorável (improcedência mantida ou restabelecida) em ação indenizatória por
acidente de trabalho típico, o reclamante interpôs recurso de revista, a Presidência do TRT **denegou
seguimento**, e contra a denegação foi interposto agravo de instrumento — abrindo-se prazo comum para
**contrarrazões ao RR e contraminuta ao AI** (art. 897, § 6º, da CLT). Complementa
[responsabilidade_civil_acidente_tipico.md](responsabilidade_civil_acidente_tipico.md) (regime de
responsabilidade e quantificação, tratados no mérito de origem) e
[estabilidade_acidentaria_e_cat.md](estabilidade_acidentaria_e_cat.md) (pressupostos formais). Aqui o
recorte é a fase extraordinária: como impedir o conhecimento do recurso e, no mérito eventual, sustentar a
ausência de culpa sem reabrir fatos e provas já fixados no acórdão.
...
Reconhecer acidente e nexo causal não implica reconhecer responsabilidade — a culpa é categoria autônoma
que exige a indicação de **conduta ou omissão patronal concreta**, e não se presume do sinistro, da CAT ou
de norma regulamentadora invocada em bloco. Na fase extraordinária, o argumento mais produtivo não é
rediscutir o mérito, é demonstrar que o recurso do reclamante depende de premissa fática que o acórdão não
contém — o que desloca a pretensão de subsunção para reexame de fatos e provas, vedado pela Súmula 126.

## Fundamentos

- **Separação rígida dos três pressupostos** (dano · nexo causal · culpa): a defesa deve isolar a culpa
  como categoria autônoma e exigir a indicação de conduta ou omissão patronal concreta, sob pena de a
  responsabilização subjetiva colapsar em responsabilidade objetiva por via transversa.
- **Teste da premissa fática** (o argumento mais eficaz em contrarrazões/contraminuta): confrontar, linha a
  linha, o rol de "premissas do acórdão" apresentado pelo recorrente com o texto literal do julgado. É
  recorrente o adversário converter "a prova não demonstrou X" em "a ré não comprovou X" — proposições
  distintas: a primeira é ausência de prova do fato; a segunda, um descumprimento de encargo processual que
  o julgado não afirmou. Demonstrada a substituição, a pretensão deixa de ser subsunção e passa a ser
  reexame → Súmula 126.
- **Inversão do ônus da prova só com decisão prévia** — art. 818, §§ 1º e 2º, da CLT: a distribuição
  ...
  desincumbir. Inversão invocada pela primeira vez em recurso é vedada (c/c arts. 9º e 10 do CPC). Tese
  aplicável sempre que o reclamante invocar "aptidão para a prova" em grau recursal.
- **Contra a alegação de prova diabólica**: a prova exigida do autor é de fato positivo (dinâmica do
  acidente, ordem insegura, ausência de sinalização, trânsito em zona de operação), demonstrável por prova
  testemunhal. Insucesso probatório ≠ encargo impossível.
...
- **NR (Norma Regulamentadora) é ato administrativo do Executivo** — não é "lei federal" para fins do art.
  896, "c", da CLT. Alegação genérica de violação a NR, sem indicação do item descumprido, é raciocínio
  circular (extrai do acidente a prova de sua causa). `[REVISAR: conferir jurisprudência atual sobre NR e
  art. 896, "c", CLT]`
...
Precedente adverso trazido pelo próprio reclamante nos autos, do TRT da 4ª Região: **ROT
0020210-77.2020.5.04.0861** (2ª T., Rel. Des. Marçal Henri dos Santos Figueiredo, DEJTRS 01/03/2023) e
**ROT 0020073-44.2021.5.04.0511** (5ª T., Relª Desª Rejane Souza Pedra, DEJTRS 06/09/2024) — sustentam
culpa presumida do empregador a partir do art. 157 da CLT. Contraponto: ambos partem de premissa de ato
ilícito comprovado e/ou incapacidade permanente; são inespecíficos (Súmula 296, I) quando o acórdão local
afastou expressamente a prova do ilícito. `[REVISAR: não lidos em fonte primária pelo Claude; conferir
inteiro teor antes de citar ou distinguir]`
...
- **Se a ECT tiver juntado documentação de segurança** (ficha de treinamento do operador, ordem de serviço,
  laudo de inspeção, procedimento de isolamento de área), inverter a lógica: em vez de sustentar que o
  encargo era do autor, demonstrar que a ré se desincumbiu — argumento mais forte.
- **Se só houver contrarrazões** (RR admitido, sem AI), suprimir a parte da contraminuta, mantendo a
  numeração corrida.

## Ligações

- [responsabilidade_civil_acidente_tipico.md](responsabilidade_civil_acidente_tipico.md) — regime de
  responsabilidade (subjetiva x objetiva) e quantificação, discutidos no mérito de origem.
- [estabilidade_acidentaria_e_cat.md](estabilidade_acidentaria_e_cat.md) — pressupostos formais da CAT e da
  estabilidade acidentária.
- [doenca_ocupacional.md](doenca_ocupacional.md) — as três frentes de defesa (incapacidade, nexo, culpa); a
  exigência de indicação da norma específica descumprida vale tanto para o perito quanto para o recorrente.
- [teses/transversal/prerrogativas_processuais_ect.md](../transversal/prerrogativas_processuais_ect.md) —
  prazo em dobro e dispensa de preparo, a conferir no parágrafo de tempestividade.
- Modelo estrutural:
  [modelos/trabalhista/contrarrazoes_rr_contraminuta_ai__acidente_trabalho.md](../../modelos/trabalhista/contrarrazoes_rr_contraminuta_ai__acidente_trabalho.md).

## Lacunas

- [ ] Conferir teor literal e vigente das Súmulas 126, 296 (I), 297 (I e II) e 337 do TST antes de cada
      protocolo.
- [ ] Conferir jurisprudência atual sobre NR como ato administrativo para fins do art. 896, "c", da CLT.
- [ ] Ler em fonte primária os dois precedentes do TRT4 (ROT 0020210-77.2020.5.04.0861 e ROT
      0020073-44.2021.5.04.0511) antes de citar ou distinguir em peça real.
