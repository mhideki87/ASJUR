---
area: trabalhista
tema: Redução de jornada para acompanhamento de dependente com deficiência (Tema 138 do TST)
slug: reducao_jornada_dependente_deficiencia
status: rascunho
...
Empregado(a) público(a) celetista pede **redução de jornada sem redução remuneratória e sem compensação de
horário** para acompanhar filho com transtorno do espectro autista (TEA) ou outro dependente com deficiência.
Costuma vir como **obrigação de fazer com multa**, às vezes em tutela antecipada.

Tema em que a ECT hoje **perde o núcleo do pedido**: a defesa útil é de contenção — extensão da redução,
comprovação periódica e delimitação das verbas —, não de improcedência total.

## Tese central (contrária à ECT)

**Tema 138 dos recursos repetitivos do Tribunal Pleno do TST**: o empregado público que possui filho com TEA
...
Rejeitados um a um por Turma do TRT24 em ago/2026 (nº do processo omitido — dado de caso real):

- ausência de previsão na CLT / impossibilidade de analogia com a Lei nº 8.112/90 — superado pelo Tema 138;
- violação dos arts. 5º, 37 e 173, § 1º, II, da CF/88: a analogia é pontual, não estatutariza o empregado
...
## Onde há espaço real de defesa

Por ordem de eficácia comprovada:
...
2. **Comprovação periódica** — pedido sucessivo **acolhível**: a manutenção da jornada especial pode ser
   ...
   Pedir sempre — e pedir, no mesmo tópico, que se fixem **prazo, forma, iniciativa e consequência do
   descumprimento**, sob pena de a condição nascer inexequível.
...
- Prerrogativas de prazo e preparo usadas na tempestividade de qualquer peça do tema:
  [teses/transversal/prerrogativas_processuais_ect.md](../transversal/prerrogativas_processuais_ect.md)
- Modelo estrutural de embargos, cujos vícios-padrão saíram justamente deste tema:
  [modelos/trabalhista/embargos_declaracao__generico.md](../../modelos/trabalhista/embargos_declaracao__generico.md)
