...
```
DA EQUIPARAÇÃO À FAZENDA PÚBLICA                     (título centralizado)
...
RESUMO DA DEMANDA                                    (título centralizado)
...
PRELIMINARMENTE                                      (título centralizado)
  1. AUSÊNCIA DE DIREITO ADQUIRIDO – JULGAMENTO PELO C. TST DO INCJULGRREMBREP – 528-80.2018.5.14.0004
       ...
       para o mérito.
       [SE CONFIRMADO o cancelamento do item I da Súmula 372, inserir aqui o bloco correspondente]
...
PREJUDICIAL DE MÉRITO – PRESCRIÇÃO                   (título centralizado)
...
DOS PEDIDOS                                          (título centralizado)
